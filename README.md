# 🚀 Senior Full Stack Software Engineer | High Performance & Scalability
...
Mi entorno de desarrollo principal es un **Mac M1**, optimizado para la máxima productividad y rendimiento técnico:

* **Backend:** Node.js (Express), PHP (Laravel, CodeIgniter), Java (Spring Boot), Python (FastAPI).
* **Frontend:** Vue.js (Ecosystem), React, JavaScript (ES6+), UI/UX Responsive.
* **Database & Infrastructure:** MySQL, MongoDB, AWS (RDS, S3, Route53), Docker.
* **Architecture & Patterns:** Event-Driven Architecture, Microservices, SOLID, Clean Code.
...
Actualmente profundizo en la excelencia técnica y nuevas fronteras tecnológicas:
* **Arquitectura:** Implementación de patrones avanzados para sistemas escalables y mantenibles.
* **Infraestructura:** Orquestación y despliegue automatizado con **Docker**.
* **Modern Web:** Explorando el potencial de **Next.js** e integración de **IA Generativa** en flujos de trabajo de ingeniería.
